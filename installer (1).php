...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220329_voyage_tp_a046ed63bc62ce261545_20220329102917_archive.zip';
	const ARCHIVE_SIZE		 = '50861629';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a046ed6-29102917';
    const SECONDARY_PACKAGE_HASH = '18970ed-29102917';
	const VERSION			 = '1.4.4';
