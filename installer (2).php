...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Laurent_DEVOPS34_TP_Vin_543e92b1bccaa3959483_20220401122746_archive.zip';
	const ARCHIVE_SIZE		 = '83070371';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '543e92b-01122746';
    const SECONDARY_PACKAGE_HASH = 'ccbe504-01122746';
	const VERSION			 = '1.4.4';
